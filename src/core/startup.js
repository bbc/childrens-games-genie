 ...
 * @param  transitions Loads the transitions JSON object given in main.js.
 * @param  initialAdditionalState Passes additional state that is added to the inState context.
 * @return {Promise} Returns a Promise, which is resolved with the game in onStarted.
 */
